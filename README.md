...
* **Éditeurs :** `VS Code`, `Arduino IDE`, `Thonny`
* **Le petit plus :** `Antigravity` 🐍 (parce que coder doit rester fun !)
...
* **SAE de 1ère année** : Développement de scripts et d'applications au sein du cursus IUT.
* **Expérimentations Arduino** : Projets de domotique et capteurs, volant de SimRacing
